  ...
  return (
    <>
      <div className="flex flex-col">
        <div className="ml-14 xp:ml-20 xs:w-[22rem] grid grid-cols-2 xm:grid-cols-3 sm:grid-cols-3 md:grid-cols-3 xp:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mt-6 px-5">
          {uniqueCategories.map((category, index) => (
            ...
            >
              <img
                src={
                  cockTail.find((cocktail) => cocktail.strCategory === category)
                    ?.strDrinkThumb
                }
        ...
        <div className="ml-14 xp:ml-20 grid grid-cols-2 xp:grid-col-3 xm:grid-cols-3 sm:grid-cols-3 md:grid-cols-3 xp:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mt-4 px-5">
          {cockTail.length > 0 ? (
