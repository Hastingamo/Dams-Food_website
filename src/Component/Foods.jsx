...
function Foods() {
  return (
    <>
      <div>
        <div className="grid grid-cols-2 xm:grid-cols-3 sm:grid-cols-3 md:grid-cols-3 xp:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-6 mt-6 px-5">
          <div className="shadow-lg justify-center items-center flex flex-col gap-3 p-5 bg-white rounded-lg">
            <img src="Images/breakfast.png" className="w-5 h-6" alt="" srcset="" />
