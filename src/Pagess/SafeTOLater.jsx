  ...
  return (
    <>
      <div className="flex flex-row items-center justify-center   bg-[#C88D84]">
        <Sidebars />
        <div className="w-screen  ml-[80px]">
              ...
              {safeToLater.length === 0 ? (
                ...
                <div>
                  {safeToLater.map((item) => (
                    <div
                      key={item.id}
                      className="flex flex-row md:grid md:grid-cols-3 items-center mb-4 gap-4 xl:ml-32 bg-gradient-to-bl from-[#8e5047] to-fuchsia-50 p-4"
                    >
                      <img
                        src={item.image}
                        alt={item.title}
