...
function CockTailss() {
  ...
  return (
    <>
      <div className="flex flex-row items-center bg-[#B0D0D3] justify-center overflow-x-hidden">
        <div>
          <Sidebars />
        </div>
        {loading ? (
          ...
          <div className="w-full min-h-screen flex flex-row bg-[#B0D0D3] justify-center ml-[36px] pt-10 px-4 overflow-x-hidden">
            <div>
              <Sidebars />
            </div>
